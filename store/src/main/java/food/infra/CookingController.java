...
public class CookingController {
    ...
    @RequestMapping(
        value = "cookings/{id}/acceptorreplace",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8"
    )
    public Cooking acceptorreplace(
        @PathVariable(value = "id") Long id,
        @RequestBody AcceptorreplaceCommand acceptorreplaceCommand,
        HttpServletRequest request,
        HttpServletResponse response
    ) throws Exception {
        System.out.println("##### /cooking/acceptorreplace  called #####");
        ...
        cooking.acceptorreplace(acceptorreplaceCommand);
